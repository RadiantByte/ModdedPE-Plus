...
object MinecraftPackageHelper {
    ...
    fun autoDetectMinecraftPackage(context: Context): String? {
        ...
        com.mcal.mcpelauncher.data.Preferences.setMinecraftPackageName(preferredPackage)

        return preferredPackage
    }
    fun getMinecraftInstallationInfo(context: Context): String {
        val info = StringBuilder()
        val currentPackage = com.mcal.mcpelauncher.data.Preferences.minecraftPackageName
